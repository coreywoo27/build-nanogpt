...
This repo is based on [nanoGPT](https://github.com/karpathy/nanoGPT/tree/master), with the dataset changed.
Also, post-training part(SFT and RLHS) has been added.



The git commits were specifically kept step by step and clean so that one can easily walk through the git commit history to see it built slowly. Additionally, there is an accompanying [video lecture on YouTube](https://youtu.be/l8pRSuU81PU) where you can see me introduce each commit and explain the pieces along the way.
